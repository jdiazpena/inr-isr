# -*- coding: utf-8 -*-
"""
train_radar_3d_window_reference_reg_diagnostic.py
...
def build_dataset(args: argparse.Namespace) -> RadarTimeH5Dataset:
    """Load one altitude-selected AMISR time window."""

    return RadarTimeH5Dataset(
...
def train(args: argparse.Namespace) -> None:
    """Train one real-radar SIREN window using the shared optimization engine."""
    ...
    train_window(
        ...
        diagnostics_without_regularization=False,
    )
