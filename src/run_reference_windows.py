# -*- coding: utf-8 -*-
"""
run_reference_windows.py

Sequential wrapper for src/train_radar_3d_window_reg.py.
...
Run from the project root:
    ...
    python scripts/run_reference_windows.py --dry_run

    python scripts/run_reference_windows.py

Resume without rerunning completed windows:

    python scripts/run_reference_windows.py --skip_existing
"""
...
TRAIN_SCRIPT = str(PROJECT_ROOT / "src" / "train_radar_3d_window_reference_reg_diagnostic.py")
...
DEFAULT_NUM_COLLOCATION = 2*8192
...
def main() -> None:
    ...
    if not Path(TRAIN_SCRIPT).exists():
        raise FileNotFoundError(
            ...
            "The project source tree is incomplete."
        )
