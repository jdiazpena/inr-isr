...
The analysis uses `src/synthetic_analyze_reconstruction.py`, so density errors are computed in physical linear density units after converting predicted `log10(Ne)` back to `Ne`.
...
- `outputs/comparison/regional_error_summary.csv`
- `outputs/comparison/regularization_sweep_summary.csv`
- `outputs/comparison/training_final_rows.csv`
- `outputs/comparison/density_rmse_by_region.png`
- `outputs/comparison/density_p95_by_region.png`
- `outputs/comparison/gradient_rmse_by_region.png`
- `outputs/comparison/loss_history_comparison.png`
- `outputs/comparison/derivative_diagnostic_comparison.png`
- `outputs/comparison/regularization_sweep_findings.md`
